      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <a href="/" className="text-2xl text-[#66b3ff]">rescaf</a>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            {isHome ? (
              <>
                ...
                <a href="/culture" className="text-gray-700 hover:text-[#66b3ff] transition-colors">Culture</a>
                <a href="#partner" className="text-gray-700 hover:text-[#66b3ff] transition-colors">Partner</a>
              </>
            ) : (
              <>
                <a href="/" className="text-gray-700 hover:text-[#66b3ff] transition-colors">Home</a>
                <a href="/culture" className="text-gray-700 hover:text-[#66b3ff] transition-colors">Culture</a>
              </>
            )}
          </div>
            ...
            <div className="flex flex-col gap-4">
              {isHome ? (
                <>
                  ...
                  <a href="/culture" className="text-gray-700 hover:text-[#66b3ff] transition-colors" onClick={() => setIsOpen(false)}>Culture</a>
                  <a href="#partner" className="text-gray-700 hover:text-[#66b3ff] transition-colors" onClick={() => setIsOpen(false)}>Partner</a>
                </>
              ) : (
                <>
                  <a href="/" className="text-gray-700 hover:text-[#66b3ff] transition-colors" onClick={() => setIsOpen(false)}>Home</a>
                  <a href="/culture" className="text-gray-700 hover:text-[#66b3ff] transition-colors" onClick={() => setIsOpen(false)}>Culture</a>
                </>
              )}
            </div>
